<div id="formEditContainer" class="p-3 mb-4 rounded shadow-sm" style="display:none; background-color:#EBF5FF; border:1px solid #B3D9FF;">
    <h5 class="fw-bold mb-3" style="color:#0158a4;">Edit Data Hose</h5>
    <hr class="my-3">

    <form id="editHoseForm" class="row g-3">
        @csrf
        <input type="hidden" id="edit_hoseId">

        <div class="col-md-10">
            <label class="form-label fw-bold">Nama Hose</label>
            <input type="text" class="form-control" id="edit_namaHose" name="nama" required>
        </div>
